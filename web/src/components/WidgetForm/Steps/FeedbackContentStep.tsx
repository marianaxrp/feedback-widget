  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        <textarea
          className="min-w-[304px] w-full min-h-[112px] text-sm placeholder-zinc-500 text-zinc-800 border-zinc-300 scrollbar-thumb-zinc-200 dark:placeholder-zinc-400 dark:text-zinc-100 dark:border-zinc-600 bg-transparent rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none resize-none dark:scrollbar-thumb-zinc-700  scrollbar-track-transparent scrollbar-thin"
